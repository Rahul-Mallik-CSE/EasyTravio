...
export default function BookingForm({ priceSection, onSubmit, submitLabel = 'Confirm And Pay' }: BookingFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!infoConfirmed) newErrors.infoConfirmed = 'Please confirm your information before proceeding'
