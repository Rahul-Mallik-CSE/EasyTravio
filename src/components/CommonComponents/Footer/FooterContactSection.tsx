    ...
    <div className="w-full bg-[#D9D9D9] px-4 md:px-6 lg:px-8 py-4">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row flex-wrap items-center justify-between gap-3 text-[12.5px] text-gray-600">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-tertiary hover:text-theme transition-colors font-semibold">Copyright EasyTravio</span>
        </div>
        ...
        <p className="text-base text-tertiary hover:text-theme transition-colors font-bold">
          &ldquo;EasyTravio: Seamless Journeys, Unrivalled Travel Wisdom!&rdquo;
        </p>
